...
#'
#' @param gdf A geodataframe (sf) # sf wurde mit jetzt immer vorgeschlagen besser?
...
#' @param fill_colors The colors to fill the polygons with (named character vector) #THIS NEEDS AN EXAMPLE
#' @param color_pal The color palette to use for fill_colors (function). Only necesary if no fill_colors are specified
